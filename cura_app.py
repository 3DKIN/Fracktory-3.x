...
parser = argparse.ArgumentParser(prog = "fracktory",
                                 add_help = False)
...
if not known_args["debug"]:
    def get_cura_dir_path():
        if Platform.isWindows():
            return os.path.expanduser("~/AppData/Roaming/fracktory")
        elif Platform.isLinux():
            return os.path.expanduser("~/.local/share/fracktory")
        elif Platform.isOSX():
            return os.path.expanduser("~/Library/Logs/fracktory")
