...
class CuraSplashScreen(QSplashScreen):
    def __init__(self):
        ...
        splash_image = QPixmap(Resources.getPath(Resources.Images, "fracktory-splash.png"))
    ...
    def drawContents(self, painter):
        ...
        painter.drawText(315, 100, 480 * self._scale, 230 * self._scale, Qt.AlignLeft | Qt.AlignTop, version[0])
        if len(version) > 1:
            font.setPixelSize(16)
            painter.setFont(font)
            painter.setPen(QColor(200, 200, 200, 255))
            painter.drawText(363, 178, 480 * self._scale, 255 * self._scale, Qt.AlignLeft | Qt.AlignTop, version[1])
        painter.setPen(QColor(255, 255, 255, 255))
        ...
        painter.setPen(pen)
        painter.drawArc(60, 175, 32 * self._scale, 32 * self._scale, self._loading_image_rotation_angle * 16, 300 * 16)
        ...
        if self._current_message:
            ...
            painter.setPen(pen)
            painter.setFont(font)
            painter.drawText(100, 141, 180, 89,
